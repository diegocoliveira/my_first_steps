...
function enviar(e) {
  try{
    ...
    result.innerHTML+="<p>Name: <strong>"+user.name+"</strong></p>";
    result.innerHTML+="<p>BirthDate: <strong>"+user.birthDate+"</strong></p>";
    result.innerHTML+="<p>Weight: <strong>"+user.weight+"</strong></p>";
    result.innerHTML+="<p>Height: <strong>"+user.height+"</strong></p>";
    result.innerHTML+="<p>Gender: <strong>"+user.gender+"</strong></p>";
    result.innerHTML+="<p>JSON: <strong>"+JSON.stringify(user, null, " ")+"</strong></p>";
...
function validarWeight(weight) {
  if (weight.length >0 && isNaN(weight.replace(",", ".")) === false) {
...
function validarHeight(height) {
  ...
  if (height.length > 0 && Number.isInteger(value) == true) {
